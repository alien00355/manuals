...
<!-- 标题改动说明：将原"安全提示""安全提示 (2)"合并为"## 安全注意事项"，其下多个h2标题（警告、注意、温馨提示）降为h3子标题并去除【】符号；"产品简介""产品简介 (2)""产品简介 (3)"合并为"## 产品介绍"，将部件展示、操作面板、产品参数、底部图标说明归入h3子标题；新增"## 功能说明"将待机、烹煮、保温、预约、使用提示、防干烧归入h3子标题；"滤网安装操作步骤""烹煮操作步骤""烹煮操作步骤 (2)"合并为"## 操作步骤"；"服务指南""服务指南 (2)"拆分为"## 故障排除"和"## 环保信息"；"产品合格证""声明""以换代修原则""有效凭证""服务内容"整合为"## 售后服务"的h3子标题。 -->
