...
\- 必须使用自来水为源水且水温不得大于 40^{\circ} \mathrm{C} ！当进水水温大于 40^{\circ} \mathrm{C} 时，会损坏反渗透膜，使反渗透膜失效。
...
当环境温度低于 5^{\circ} \mathrm{C} 时, 请务必采取防冻措施, 如开暖气或空调等, 防止由于温度过低, 机器内的水结冰造成机器管件开裂而发生漏水漏电事故。
